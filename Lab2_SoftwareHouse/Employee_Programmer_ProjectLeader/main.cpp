...
class SoftwareHouse {
    ...
    list<ProjectLeader *> projectLeaders;
public:
    // constructor
    ...
    void setName(string name);
    void addProgrammer(Programmer *programmer);
    void addProjectLeader(ProjectLeader *projectLeader);
...
void SoftwareHouse::addProjectLeader(ProjectLeader *projectLeader) {
    this->projectLeaders.push_back(projectLeader);
}
...
void SoftwareHouse::display() {
    ...
    cout << "Project Leaderes:\n";
    for (auto projectLeader : this->projectLeaders) {
